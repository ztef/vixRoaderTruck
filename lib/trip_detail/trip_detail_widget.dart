                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          dateTimeFormat('yMMMd', tripDetailTripsRecord.date),
                        ...
                        Text(
                          dateTimeFormat('jm', tripDetailTripsRecord.date),
                          style: FlutterFlowTheme.of(context).bodyText1,
                        ),
                        Padding(
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            ...
                                            child: CustomerSelectorWidget(
                                              customer: tripDetailTripsRecord
                                                  .customer,
                                            ),
                                          );
                                        },
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            tripDetailTripsRecord.customer,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText1,
                                          ),
                                        ],
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            ...
                                            child: LoadSelectorWidget(
                                              load: tripDetailTripsRecord.load,
                                            ),
                                          );
                                        },
                                      );
