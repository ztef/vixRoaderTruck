...
class CustomerSelectorWidget extends StatefulWidget {
  ...
  @override
  _CustomerSelectorWidgetState createState() => _CustomerSelectorWidgetState();
}
...
class _CustomerSelectorWidgetState extends State<CustomerSelectorWidget> {
  ...
  void initState() {
    super.initState();
    textController = TextEditingController(text: widget.customer);
  }
